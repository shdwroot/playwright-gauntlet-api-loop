...
export async function loadConfig(configPath = 'gauntlet.config.json'): Promise<{ config: GauntletConfig; configPath: string }> {
  ...
  const config: GauntletConfig = {
    ...
    agents: {
      ...
      maxInputCharacters: positiveInteger(agentsRaw, 'maxInputCharacters', 160_000),
      maxRunInputCharacters: positiveInteger(agentsRaw, 'maxRunInputCharacters', 3_000_000),
      maxCalls: positiveInteger(agentsRaw, 'maxCalls', 60),
      maxOutputTokens: positiveInteger(agentsRaw, 'maxOutputTokens', 8000),
      reviewBatchSize: positiveInteger(agentsRaw, 'reviewBatchSize', 8),
